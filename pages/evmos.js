...
import EvmosAsset from '../assets/EvmosAsset';
import Sidebar from '../assets/Sidebar';
import Head from 'next/head';

const EvmosAssetWithNoSSR = dynamic(() => import('../assets/EvmosAsset'), {
  ssr: false,
});

export default function Evmos() {
  return (
        ...
        {({ provider, account, connectWallet, disconnectWallet }) => (
          <>
            ...
            <Head>
              ...
              <meta property="og:description" content="Build and deploy a meme coin instantly on Evmos. Fast, secure, and 100% code-free." />
              <meta property="og:type" content="website" />
              <meta property="og:url" content="/evmos" />
            </Head>

            <div className="container mx-auto p-4 max-w-7xl flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <EvmosAssetWithNoSSR provider={provider} account={account} connectWallet={connectWallet} />
              </div>
